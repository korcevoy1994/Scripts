...
(() => {
  ...
  function addQuoteItemsToHiddenInput(item) {
    ...
    hiddenInput.name = `Item: ${item["name"]} (Category: ${item["category"]})`; // Добавили отображение категории
    ...
    Object.keys(quoteItems).forEach(function(key) {
      ...
      const cartItem = `
            ...
            <div class="cart-item-information">
              ...
              <div class="cart-item-information-category">Category: ${quoteItems[key]["category"]}</div> <!-- Добавили отображение категории -->
